-- Household cookbook entries keep the complete generated recipe snapshot so
-- saved recipes remain usable after a feed session expires.
...
CREATE POLICY "Household members can remove saved recipes"
